...
<header class="header">
	<div class="page_container">
		<a href="home.php" class="header_logo">Sponser.Com</a>
        <?php 
...
<?php 
if($page!='profile' && $page!='shopping_cart' && $page!='orders' && $page!='checkout1' && $page!='checkout2' && $page!='checkout3' && $page!='checkout4' && $page!='invoice' && $page!='wallet')
{
...
switch ($page) {
    ...
    case 'checkout2':
        ...
        break;
    case 'checkout3':
        include("checkout3.php");
        break;
    case 'checkout4':
        include("checkout4.php");
        break;
    case 'invoice':
        include("invoice_order.php");
        break;
    case 'wallet':
        include("wallet_status2.php");
        break;
