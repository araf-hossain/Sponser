...
$views=mysql_query("SELECT MAX(views) AS max_views FROM user_views");
$fetch_views=mysql_fetch_array($views);
				// {
				// 	$increment_views=$fetch_views[0];
				// 	$new_count=$increment_views+1;
				// 	mysql_query("UPDATE user_views SET views='$new_count'");
				// 	print $new_count;
				// }
 ?>
...
<html>
<head>
<title>Sponser Admin Panel</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="Sponser Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, 
            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left">
							<div class="logo-name">
									<a href="home.php">
									<img id="logo" style="margin-top:5px" src="images/icons/spnsr.png" alt="Logo"/>
								  </a> 								
							</div>
							<!--search-box-->
...
<!--market updates updates-->
	 <div class="market-updates">
			<div class="col-md-4 market-update-gd">
				...
				<?php 
				$slct_user=mysql_query("SELECT email FROM user_signup");
				// $fetch_user=mysql_fetch_array($slct_user);
				$count=mysql_num_rows($slct_user);
				 ?>
					<div class="col-md-8 market-update-left">
						<h3><?php print $count; ?></h3>
			...
			<div class="col-md-4 market-update-gd">
				...
				<?php  ?>
				 <div class="col-md-8 market-update-left">
					<h3><?php print $fetch_views["max_views"]; ?></h3>
			...
			<div class="col-md-4 market-update-gd">
				...
				<?php 
				$slct_pdt=mysql_query("SELECT pdt_id FROM ad_form");
				// $fetch_user=mysql_fetch_array($slct_user);
				$count=mysql_num_rows($slct_pdt);
				 ?>
					<div class="col-md-8 market-update-left">
						<h3><?php print $count; ?></h3>
						<h4>Total Products</h4>
						<p>All Products Advertise</p>
					</div>
					<div class="col-md-4 market-update-right">
...
<div class="copyrights">
	 <p>© 2016 Sponser. All Rights Reserved | Design by  <a href="http://w3layouts.com/" target="_blank">W3layouts</a> </p>
</div>	
		      ...
		      <ul id="menu" >
		        ...
		        <li id="menu-comunicacao" ><a href="#"><i class="fa fa-book nav_icon"></i><span>Element</span><span class="fa fa-angle-right" style="float: right"></span></a>
		          <ul id="menu-comunicacao-sub" >
		            <li id="menu-mensagens" ><a href="allinhome.php?page=item_info">Item Information</a></li>
		            <li id="menu-arquivos" ><a href="allinhome.php?page=cate_info">Category Information</a></li>
		            <li id="menu-arquivos" ><a href="allinhome.php?page=pdt_info">Product Information</a></li>
		          </ul>
		        </li>
